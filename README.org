...
- allows you to keep maintain the config in a git repo for backup and deployment
  to other machines

* How does it do it

All config goes into a carbs or dotfiles folder that you git clone onto the
