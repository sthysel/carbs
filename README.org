...
CARBS uses Tuckr to manage dotfiles. Tuckr provides hooks, secrets management,
and zero-configuration setup. Its like stow, but with hooks, and focused on dots
management.
